            ...
            {current < slides.length && (
                <>
                    ...
                    >
                        ...
                        <span className='absolute right-1 md:right-3 uppercase font-bold tracking-widest text-slate-100 -rotate-90'>Uenig</span>
                    </motion.button>
                    ...
                    >
                        ...
                        <span className='absolute left-3 md:left-5 uppercase font-bold tracking-widest text-slate-100 rotate-90'>Enig</span>
                    </motion.button>
                </>
            )}
