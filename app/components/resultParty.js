    ...
    return (
        <div className="w-full flex flex-col items-stretch mb-5">
            ...
            >
                ...
                <p className="font-normal text-xs text-gray-400 pl-5 leading-snug">Antallet af deltagende kandidater fra hvert parti er angivet i parentes. <br />Vi tager højde for skævheder, der opstår med forskellige antal deltagere fra partierne, ved at anvende en gennemsnitsberegning, der sikrer et normaliseret og retfærdigt resultat.</p>
            </motion.div>
        </div>
    )
}    
